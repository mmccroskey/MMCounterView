...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                   An optional longer description of MMCounterView
  #
  #                   * Markdonw format.
  #                   * Don't worry about the indent, we strip it!
  #                  DESC
  s.homepage     = "http://EXAMPLE/MMCounterView"
  ...
  # s.authors      = { "Matthew McCroskey" => "matthew.mccroskey@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Matthew McCroskey', 'other author'

  # Specify the location from where the source should be retreived.
  #
  s.source       = { :git => "http://EXAMPLE/MMCounterView.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/MMCounterView/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/MMCounterView', :revision => '1.0.0' }
